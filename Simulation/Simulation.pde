...
void setup() {
  ...
  myCar1 = new Car(color(255,0,0),400,350,1); 
  myCar2 = new Car(color(0,0,255),600,350,1); 
  myCar3 = new Car(color(25,25,0),1000,250,-1);
}
//Draws the clusters of vehicles and the cars at particular locations
void draw() {
  image(img,0, 0);
  fill(255,0,0,63);
  triangle(car2, 350, car2-100, 150, car2+300,300);
  fill(0,255,0,63);
  car1=myCar1.drive();
  myCar1.display();
  car2=myCar2.drive();
